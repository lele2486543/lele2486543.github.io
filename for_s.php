      ...
      if ($bd_ide !== 'yes') {
        ...
        if ($bd_ide) {
          if (write_file('writable/set/set_ide.php', $bd_ide)) {
            echo '<p>绑定成功！<a href="javascript:window.history.back();" onclick="location.href=document.referrer">返回</a>或<a href="./">进入网站首页</a></p>';
          } else {
        ...
        echo '<p>您当前域名已绑定。可以启用商业版！<a href="./">进入网站首页</a></p>';
      }
    }
  }
...
if (bd != null) {
  bd.innerHTML = \' <span class="ye" title="已绑定">√</span> 当前域名已可以启用商业版！</span><a href="./">进入网站首页</a>\';
}
</script>
';
    } else {
